...
public class SwipeTriggerRippleDrawable extends Drawable {
  ...
  public void play(@ColorInt int color, RippleDirection rippleDirection, RippleType swipeRippleType) {
    if (animator != null) {
      animator.cancel();
    }
    ...
    radiusAnimator.addUpdateListener(animation -> {
      ...
      if (rippleDirection == RippleDirection.START_TO_END) {
    ...
    animator.setInterpolator(Animations.INSTANCE.getINTERPOLATOR());
